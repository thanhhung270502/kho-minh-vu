-- =============================================================================
-- 0031 — Thẻ kho một mã, gộp dữ liệu KiotViet cũ (DMUC-05, D-21)
--
...
comment on function public.the_kho_san_pham(uuid, uuid, int, int) is
  'Thẻ kho một mã (D-21): kho_movement của hệ mới gộp với phiếu nhập/hóa đơn KiotViet cũ, mỗi dòng gắn nhãn nguon. Dòng KiotViet chỉ quản lý/văn phòng thấy và biến mất khi lọc theo kho (dữ liệu cũ không có kho). Không cộng vào tồn. Component thẻ kho dùng lại cho TON-02 ở Phase 5.';
